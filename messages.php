    ...
    <body data-spy="scroll" data-target="#navigation" data-offset="120" >
		...
		<div class="container">
			<div class="row">
				<div class="box" >
					<a href="#">
					<div><p>From: MBNB</p></div>
					<div><p>Subject: You have a booking request by USERNAME. Approval required.</p></div>
					<div class="text text-right">8/9/2017 01:45 PM</div>
					</a>
				</div>
				...
				<div class="box" >
					<a href="#">
					<div><p>From: MBNB</p></div>
					<div><p>Subject: You have a new review by USERNAME.</p></div>
					<div class="text text-right">8/9/2017 01:45 PM</div>
					</a>
				</div>
				...
				<div class="box" >
					<a href="#">
					<div><p>From: MBNB</p></div>
					<div><p>Subject: You have a new question about your hosting by USERNAME.</p></div>
					<div class="text text-right">8/9/2017 01:45 PM</div>
					</a>
				</div>
