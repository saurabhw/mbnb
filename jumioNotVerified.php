...
<html class="no-js">
    ...
    <body data-spy="scroll" data-target="#navigation" data-offset="120" >
		...
		<div class="container" id="body">
			<div class="row box">
				<h3 class="box-header text-center">Identity Not Verified.</h3>
				<p>Please verify your identity using jumio in order to proceed</p>
				<form action="jumio.php" method="post">
					<div class="text-center"><button class="btn btn-success">Proceed to Identity Verification</button></div>
				</form>	
			</div>
