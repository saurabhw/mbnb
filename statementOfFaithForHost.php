...
<html class="no-js">
    ...
    <head>
		...
		<link href="css/statementOfFaithForHost.css" rel="stylesheet">
    ...
    <body data-spy="scroll" data-target="#navigation" data-offset="120" >
		...
		<div class="container">
			<div class="row box">
				...
				<form  method="post" action="sofHost.php" onsubmit="checkTheForm(event)" >					
					<div class="col-md-6">
						<div>Home Church<sup>*</sup></div>
						<input type="text" class="form-control form-group" id="homeChurch" name="homeChurch">
						
						<div>Role at church<sup>*</sup></div>
						<input type="text" class="form-control form-group" id="roleAtChurch" name="roleAtChurch">
						
						
						
						<fieldset>
						  <legend>Church Address:<sup>*</sup></legend>
...
To this end I embrace all those who make this confession as they are my brothers and sister in Christ. I commit to love them as Christ loves me and care for them as they are.</p>
			...
			<div class="text-center"style="margin-bottom:1em;"><input type="submit" name="Contunue_to_Identity_verification" value="Contunue to Identity verification" class="btn btn-success"></div>
			</form>
		</div>
		...
		<!-- Custom js -->
		<script src="js/statementOfFaithForHost.js"></script>
