...
<html class="no-js">
    ...
    <body data-spy="scroll" data-target="#navigation" data-offset="120" >
		...
		<div class="container">
			<div class="row box">
				<h3 class="box-header text-center">Choose Your Role</h3>
				<form action="registerStep1.php" method="post">
					<div class="col-md-6">
						<div class="text-center"><button type="submit" class="btn btn-success" name="role" value="HOST">I want to be a Host</button></div>
					</div>
					<div class="col-md-6">
						<div class="text-center"><button type="submit" class="btn btn-success" name="role" value="MISSIONARY">I am a Missionary</button></div>									
					</div>	
					<div class="text-center">
						Not shure? You can switch your roles in future.
					</div>
				</form>	
			</div>
